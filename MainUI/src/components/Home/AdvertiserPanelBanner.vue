    ...
    <mdb-row>
      ...
      <mdb-col class="text-center">
        ...
        <p class="text-primary">
          Note: You can only add banners of size 480*60 in this panel, anything
        ...
        <mdb-row v-if="advertisementSwitch === 1">
          <mdb-col>
            ...
            >
              <mdb-card-header class="text-secondary"
                >Banner Impressions</mdb-card-header
              >
          ...
          <mdb-col>
            ...
            >
              <mdb-card-header class="text-secondary"
                >Banner Day Impressions</mdb-card-header
              >
              <mdb-card-body class="text-secondary">
        ...
        <mdb-row v-if="advertisementSwitch === 2">
          <mdb-col>
            ...
            >
              <mdb-card-header class="text-secondary"
                >Manage Banner Advertisement</mdb-card-header
              >
              <mdb-card-body class="text-secondary">
                ...
                <mdb-btn
                  v-on:click="manageBannerSwitch = 1"
                  color="secondary"
                  size="sm"
                  >Impressions Based</mdb-btn
                >
                <mdb-btn
                  v-on:click="manageBannerSwitch = 2"
                  color="secondary"
                  size="sm"
                  >Time Based</mdb-btn
                >
                ...
                <mdb-card-text v-if="manageBannerSwitch === 1">
                  <mdb-input
                    basic
                    class="mb-3"
                    v-validate="'required'"
                  ...
                  <span class="text-danger">
                    ...
                    <span v-if="doesntExist"
                      >You do not have any such referenced banner order.</span
                    ><br />
                  </span>
                ...
                <mdb-card-text v-if="manageBannerSwitch === 2">
                  <mdb-input
                    basic
                    class="mb-3"
                    v-validate="'required'"
        ...
        <mdb-row v-if="advertisementSwitch === 3">
          <mdb-col>
            <mdb-datatable
              v-bind:data="this.$store.state.reactiveBannerOrderData"
      ...
      this.$validator
        ...
        .then(result => {
          if (result === true) {
            for (
              var i = 0;
              i < this.$store.state.reactiveBannerOrderData.rows.length;
              i++
            ) {
              if (
                this.reference ===
                  this.$store.state.reactiveBannerOrderData.rows[i].reference &&
                this.$store.state.reactiveBannerOrderData.rows[i]
                  .isTimeBased === "false"
              ) {
                hasAny = true;
                break;
