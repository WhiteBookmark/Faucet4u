...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            {
                this.axios
                    .get(process.env.VUE_APP_API_History_Withdrawal, {
        ...
        beforeMount()
        {
            ...
            this.columnDefs = [
                ...
                { headerName: 'Withdrawal Type', field: 'WithdrawalType' },
                { headerName: 'Requested Date', field: 'RequestedDate', sort: 'desc' },
                { headerName: 'Amount', field: 'RequestedAmount', valueFormatter: this.bitcoinAgGridFormat },
                { headerName: 'Status', field: 'Paid' },
                { headerName: 'Wallet', field: 'WalletType' },
                { headerName: 'Address', field: 'WalletAddress' },
