...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            {
                this.axios
                    .get(process.env.VUE_APP_API_History_Order, {
        ...
        beforeMount()
        {
            ...
            this.columnDefs = [
                ...
                { headerName: 'Purchase Date', field: 'OrderDateTime', sort: 'desc' },
                { headerName: 'Package Name', field: 'Name' },
                { headerName: 'Credit', field: 'Credit' },
                { headerName: 'Is Time Based ?', field: 'IsTimeBased' },
                { headerName: 'Package Price', field: 'Price', valueFormatter: this.bitcoinAgGridFormat }
            ];
        },
        mounted()
        {
