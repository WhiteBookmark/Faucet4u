...
{
    public class DepositMethodModel : PageModel
    {
        private static string TableData()
        {
            try
            {
                using (SqlConnection connectionObject = new SqlConnection(Other.faucet4uSQLConnectionString))
                {
                    ...
                    result[0] = connectionObject.Query("SELECT * FROM DepositMethod");
        ...
        public IActionResult OnPostAddDepositMethod()
        {
            try
            {
                #region Session validation
                ...
                using (SqlConnection connectionObject = new SqlConnection(Other.faucet4uSQLConnectionString))
                {
                    ...
                    if (connectionObject.Execute("INSERT INTO DepositMethod(Name, Address) VALUES(@Name, @Address)", new { Name = Request.Form["name"], Address = Request.Form["address"] }) > 0)
                    {
        ...
        public IActionResult OnPostModifyDepositMethod()
        {
            try
            {
                #region Session validation
                ...
                using (SqlConnection connectionObject = new SqlConnection(Other.faucet4uSQLConnectionString))
                {
                    ...
                    if (connectionObject.Execute("UPDATE DepositMethod SET Address = @Address WHERE Name = @Name", new { Name = Request.Form["name"], Address = Request.Form["address"] }) > 0)
                    {
                        ViewData["Success"] = "Success";
                        ViewData["TableData"] = TableData();
                        return Page();
        ...
        public IActionResult OnPostDeleteDepositMethod()
        {
            try
            {
                #region Session validation
                ...
                using (SqlConnection connectionObject = new SqlConnection(Other.faucet4uSQLConnectionString))
                {
                    ...
                    if (connectionObject.Execute("DELETE FROM DepositMethod WHERE Name = @Name", new { Name = Request.Form["name"] }) > 0)
                    {
                        ViewData["Success"] = "Success";
                        ViewData["TableData"] = TableData();
                        return Page();
