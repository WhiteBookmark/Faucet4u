...
namespace AdminPanel.Pages.Faucet4u
{
    public class ChatHistoryModel : PageModel
    {
        private static string TableData()
        {
            try
            {
                using (SqlConnection connectionObject = new SqlConnection(Other.faucet4uSQLConnectionString))
                {
                    ...
                    result[0] = connectionObject.Query("SELECT * FROM ChatHistory");
                    result[1] = connectionObject.Query("SELECT Username, ChatBanned FROM Users");
        ...
        public IActionResult OnPostDeleteChatMessage()
        {
            try
            {
                #region Session validation
                ...
                using (SqlConnection connectionObject = new SqlConnection(Other.faucet4uSQLConnectionString))
                {
                    ...
                    if (connectionObject.Execute(@"
                        DELETE FROM ChatHistory WHERE Reference = @Reference", new { Reference = Request.Form["reference"] }) > 0)
                    {
        ...
        public IActionResult OnPostBanChatUser()
        {
            try
            {
                #region Session validation
                ...
                using (SqlConnection connectionObject = new SqlConnection(Other.faucet4uSQLConnectionString))
                {
                    ...
                    if (connectionObject.Execute(@"
                        UPDATE Users SET ChatBanned = 1 WHERE Username = @Username", new { Username = Request.Form["username"] }) > 0)
                    {
                        ViewData["Success"] = "Success";
                        ViewData["TableData"] = TableData();
                        return Page();
        ...
        public IActionResult OnPostUnBanChatUser()
        {
            try
            {
                #region Session validation
                ...
                using (SqlConnection connectionObject = new SqlConnection(Other.faucet4uSQLConnectionString))
                {
                    ...
                    if (connectionObject.Execute(@"
                        UPDATE Users SET ChatBanned = 0 WHERE Username = @Username", new { Username = Request.Form["username"] }) > 0)
                    {
                        ViewData["Success"] = "Success";
                        ViewData["TableData"] = TableData();
                        return Page();
