...
{
    public class PTPModel : PageModel
    {
        private static string TableData()
        {
            try
            {
                using (SqlConnection connectionObject = new SqlConnection(Other.faucet4uSQLConnectionString))
                {
                    ...
                    result[0] = connectionObject.Query("SELECT * FROM PTP");
        ...
        public IActionResult OnPostAddPTP()
        {
            try
            {
                #region Session validation
                ...
                using (SqlConnection connectionObject = new SqlConnection(Other.faucet4uSQLConnectionString))
                {
                    if (connectionObject.Execute(@"BEGIN
                                                ...
                                                SET @MaxId = 0
                                                END
                                                INSERT INTO PTP(Id, Link, IsTimeBased, Credit) VALUES(@MaxId, @Link, @IsTimeBased, @Credit)
                                                END", new { Link = Request.Form["link"], IsTimeBased = Request.Form["isTimeBased"], Credit = Request.Form["credit"] }) > 0)
                    {
        ...
        public IActionResult OnPostUpdatePTP()
        {
            try
            {
                #region Session validation
                ...
                {
                    if (connectionObject.Execute(@"BEGIN
                                                UPDATE PTP SET Link = @Link WHERE Id = @Id
                                                END",
                                                new
                                                {
                                                    Id = Request.Form["id"],
        ...
        public IActionResult OnPostUpdateCreditPTP()
        {
            try
            {
                #region Session validation
                ...
                using (SqlConnection connectionObject = new SqlConnection(Other.faucet4uSQLConnectionString))
                {
                    if (connectionObject.Execute(@"BEGIN
                                                    IF(@Action = 'Add')
                                                    BEGIN
                                                    UPDATE PTP SET Credit += @Credit WHERE Id = @Id
                                                    END
        ...
        public IActionResult OnPostUpdatePTPDirectRatio()
        {
            try
            {
                #region Session validation
                ...
                {
                    if (connectionObject.Execute(@"BEGIN
                                                    DECLARE @PTPDirectRatio int = @PTPDirectRatioInput                                                    
                                                    UPDATE Settings SET PTPDirectRatio = @PTPDirectRatio
                                                    END", new { PTPDirectRatioInput = Request.Form["PTPDirectRatio"] }) > 0)
                    {
                        ViewData["Success"] = "Success";
                        ViewData["TableData"] = TableData();
                        return Page();
        ...
        public IActionResult OnPostUpdatePTPTotalRatio()
        {
            try
            {
                #region Session validation
                ...
                {
                    if (connectionObject.Execute(@"BEGIN
                                                    DECLARE @PTPTotalRatio int = @PTPTotalRatioInput                                                    
                                                    UPDATE Settings SET PTPTotalRatio = @PTPTotalRatio
                                                    END", new { PTPTotalRatioInput = Request.Form["PTPTotalRatio"] }) > 0)
                    {
                        ViewData["Success"] = "Success";
                        ViewData["TableData"] = TableData();
                        return Page();
